...
namespace LeaveReadCard
{
    public static class OMRAPIx64
    {
        ...
        // Public Declare Function OMR_SetSheetFeedMode Lib "OMRAPI.x64" (ByRef iMode As Long, ByRef iInsertTime As Long) As Long
        ...
        // Public Declare Function OMR_GetSheetFeedMode Lib "OMRAPI.x64" (ByRef iMode As Integer, ByRef iInsertTime As Integer) As Integer
        ...
        // Public Declare Function OMR_GetMarks Lib "OMRAPI.x64" (ByVal iPage As Long, ByRef stMark As OMR_MARK) As Long
